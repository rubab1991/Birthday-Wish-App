      ...
      >
        ...
        <Card className="mx-auto overflow-hidden transition-all duration-300 ease-in-out hover:shadow-xl border-2 border-black">
          ...
          <CardHeader className="text-center">
            <CardTitle className="text-4xl font-bold text-blue">Happy 5th Birthday!</CardTitle>
            <CardDescription className="text-4xl font-semibold text-blue-600">Syed Muhammad Shahzain</CardDescription>
            
          <p className="text-2xl font-semibold text-red-500">Mama loves you my darling</p>
          <p className="text-lg text-gray-500">March 26th</p>
          </CardHeader>
